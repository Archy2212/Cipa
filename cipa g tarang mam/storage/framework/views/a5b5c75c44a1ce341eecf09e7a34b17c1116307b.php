   <?php $__env->startSection('cleft'); ?> 

   <div>
    <header style="background-color:#e0a1a1; height: 250px; border-radius: 5px">
      <article id="content">
        <h2 style="text-align: center;" class="color3">
...
<li>IF 1 PARENT HAS A CLEFT AND 1 CHILD HAS A CLEFT, The chance of the next child having a cleft is 1 in 4.</li>
<li>4. IF BOTH THE PARENTS HAVE CLEFTS, The chance of the first child having a cleft is 1 in 4.</li></ul><p>If you have any doubts, your Surgeon will refer you to the Geneticist who will provide you with genetic counselling.</p>
</div>
...
<?php echo $__env->make('layout.cleft', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>